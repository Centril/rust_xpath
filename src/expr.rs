...
fn expr_size_of() {
    ...
    println!("size_of Axis:                \t {:?}",
        size_of::<Axis>());

    println!("size_of PrincipalNodeType:   \t {:?}",
        size_of::<PrincipalNodeType>());

    println!("size_of LiteralValue:        \t {:?}",
        size_of::<LiteralValue>());

    println!("size_of NameTest:            \t {:?}",
        size_of::<NameTest<&str>>());

    println!("size_of NodeTest:            \t {:?}",
        size_of::<NodeTest<&str>>());

    println!("size_of Steps:               \t {:?}",
        size_of::<Steps<&str>>());

    println!("size_of Predicate:           \t {:?}",
        size_of::<Predicate<&str>>());

    println!("size_of Expr:                \t {:?}",
        size_of::<Expr<&str>>());

    println!("size_of MasterExpr:          \t {:?}",
        size_of::<MasterExpr>());
}
